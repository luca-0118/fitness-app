...
fn get_exercise_set(
    ...
    exercise_id: String,
    set_nr: usize,
) -> Result<&mut Set, ApiErrorResponse> {
...
impl SessionService {
    ...
    pub fn save_session(&mut self) -> Result<String, ApiErrorResponse> {
        ...
        for exercise in session.exercises.iter() {
            ...
            let exercise_id = self
                .completed_exercise
                .add_exercise(AddExerciseParams {
            ...
            for set in exercise.sets.iter() {
                match set {
                    Set::Weighted {
                        ...
                        .completed_exercise
                        .add_weighted_set(AddWeighedSetParams {
    ...
    pub fn update_session_set(
        &mut self,
        set_update: UpdateSessionSetRequest,
