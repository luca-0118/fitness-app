  ...
  return <div className="z-10 bg-gray-600 fixed top-0 right-0 left-0 bottom-0 w-full h-full pt-40 mt-10 " onClick={() => onClick()}> {/** this onclick adds the fooditem to recents. */}
    <div className="fixed inset-0 top-15 bottom-15 bg-background z-20 overflow-y-auto px-5 py-5 no-scrollbar">
      ...
      <section>
        ...
        <div className="w-full max-w-md mx-auto mt-5 flex gap-4">
            ...
            <button onClick={() => addProduct()} className="cursor-pointer mx-auto sticky bottom-2 h-16 justify-center items-center font-bold w-[90%] rounded-full text-textcolor bg-accent hover:bg-accent-action active:bg-accent-action flex z-30">
              Add product
            </button>
        </div>
      </section>
