...
export default function FinishWorkoutButton({ elapsedSeconds = 0 }: FinishWorkoutButtonProps) {
    ...
    return (
        <div className="fixed bottom-24 left-1/2 z-40 w-96 max-w-[92vw] -translate-x-1/2">
            <button
                type="button"
            ...
            >
                ...
                <span className="text-lg tabular-nums">{formatTime(elapsedSeconds)}</span>
            </button>
        </div>
    );
}
