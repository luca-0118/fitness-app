...
export default function BottomNavBar() {
  return (
    <footer className="fixed bottom-0 left-0 w-full z-10000 bg-[#333737] border-t-2 border-[#565d5d] pt-2 pb-[env(safe-area-inset-bottom)]">
      <nav className="h-full max-w-sm mx-auto justify-evenly flex">
        <NavLink
          to="/"
          className={({ isActive }) =>
            `text-center items-center ${isActive ? "text-[#F67631]" : "text-[#ffffff]"}`
          }
        >
